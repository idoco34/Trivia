...
def check_build(input_cmd, input_data, expected_output):
	print("check_build Input: ", input_cmd, input_data, "\nExpected output: ", expected_output)
	try:
...
def check_parse(msg_str, expected_output):
	print("check_parse Input: ", msg_str, "\nExpected output: ", expected_output)
...
def check_split(data, expected_fields, expected_output):
	print("check_split Input: ", data, "\nExpected output: ", expected_output)

	try:
		output = chatlib.split_data(data, expected_fields)
	except Exception as e:
		output = "Exception raised: " + str(e)
...
def main():
	...
	# Valid inputs
	check_split("username#password" , 1, ("username", "password"))
